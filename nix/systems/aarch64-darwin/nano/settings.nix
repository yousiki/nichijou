# System settings for Darwin host nano.
_: {
  # Set the hostname and computer name
  networking = {
    hostName = "nano"; # The hostname of the system
    computerName = "YouSiki's Mac Mini"; # The name displayed in the network and system settings
  };

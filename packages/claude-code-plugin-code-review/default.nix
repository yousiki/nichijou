...
stdenvNoCC.mkDerivation {
  pname = "claude-code-plugin-code-review";
  ...
  meta = {
    description = "Claude Code plugin for automated PR code review with parallel agents and confidence scoring";

...
stdenvNoCC.mkDerivation {
  pname = "claude-code-plugin-plugin-dev";
  ...
  meta = {
    description = "Claude Code plugin development toolkit with hooks, MCP integration, and plugin structure guidance";

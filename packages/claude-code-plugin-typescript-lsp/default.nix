...
stdenvNoCC.mkDerivation {
  ...
  installPhase = ''
    ...
    mkdir -p $out
    cp -r plugins/typescript-lsp/. $out/
  ...
  meta = {
    description = "Claude Code plugin for TypeScript/JavaScript development with language server (go-to-definition, find references, error checking)";

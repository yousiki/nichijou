...
stdenvNoCC.mkDerivation {
  ...
  meta = {
    description = "Claude Code plugin for Python development with Pyright language server (static type checking and code intelligence)";

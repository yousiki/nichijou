...
stdenvNoCC.mkDerivation {
  pname = "claude-code-plugin-claude-code-setup";
  ...
  installPhase = ''
    ...
    mkdir -p $out
    cp -r plugins/claude-code-setup/. $out/
  ...
  meta = {
    description = "Claude Code plugin for analyzing codebases and recommending automations";

...
stdenvNoCC.mkDerivation {
  pname = "claude-code-plugin-pr-review-toolkit";
  ...
  installPhase = ''
    ...
    mkdir -p $out
    cp -r plugins/pr-review-toolkit/. $out/
  ...
  meta = {
    description = "Claude Code plugin for comprehensive PR review with 6 specialized agents";

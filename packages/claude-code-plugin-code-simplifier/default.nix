...
stdenvNoCC.mkDerivation {
  pname = "claude-code-plugin-code-simplifier";
  ...
  installPhase = ''
    ...
    mkdir -p $out
    cp -r plugins/code-simplifier/. $out/
  ...
  meta = {
    description = "Claude Code plugin for simplifying and refining code for clarity and maintainability";
